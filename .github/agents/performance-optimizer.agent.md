...
- Optimiere für Core Web Vitals: LCP < 2.5s, FID < 100ms, CLS < 0.1
...
- Minimize und compress Assets (JS, CSS, HTML)
- Nutze HTTP/2 und HTTP/3 Features
...
- Optimiere React Renders mit memoization
- Implementiere Progressive Web App (PWA) Features
- Nutze Lighthouse und Web Vitals für Performance-Audits
- Optimiere Database Queries und API Response Times
- Implementiere Server-Side Rendering oder Static Site Generation

Fokussiere dich auf Performance-Metriken und -Optimierungen. Identifiziere Performance-Bottlenecks im Code.
